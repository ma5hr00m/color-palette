...
<!-- <Hard></Hard> -->
<div class="w-full flex flex-col items-center pt5 pb20">
  ...
  <div class="w-full max-w-1180px mx8 mx4 overflow-hidden flex flex-wrap justify-center gap-3 pt1">
